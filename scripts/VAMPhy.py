...
parser.add_argument("-leftext", "--LEFTEXT", type = int, metavar = "", default = 0,
                    help = 'Left Extention  (default = 0)')

parser.add_argument("-rightext" ,"--RIGHTEXT", type = int, metavar = "", default = 0,
                    help = 'right Extention  (default = 0)')

parser.add_argument("-threshold" ,"--THRESHOLD", type = int, metavar = "", default = -1,
