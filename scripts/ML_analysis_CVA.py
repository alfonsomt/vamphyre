...
parser.add_argument('-file', type = str, metavar = '', 
                    help = 'vh_global.csv file')

parser.add_argument('-meta', type = str, metavar = '',
                    help = 'file.csv with metadata')
              
parser.add_argument('-method', type = str, metavar = '', 
                    help = 'Machine LeArning Model [SVM],[SVM-PCA],[LR],[LR-PCA],[MNB],[GNB],[MLP], [DT] (default = MNB)',
                    default = 'MNB')

parser.add_argument('-clase', type = str, metavar = '', 
                    help = 'Column name of class to classify')

parser.add_argument('-fold',  metavar = '', type = int,
                    default = 1, help = 'K-fold (default = 10)')  
 
parser.add_argument('-l_curve', type = str, metavar = '',
                    help = 'Learning curve [yes/no]  (default = no)', default = 'no')

parser.add_argument('-RD', metavar = '', type = str, 
                    help = 'Reduction dimension method PCA/tSNE/]', default = 'PCA')

parser.add_argument('-T',  metavar = '', help = '# Threads (default = 1)', type = int,
                    default = 1)  

parser.add_argument('-scale', type = str, metavar = '',
